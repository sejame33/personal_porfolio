  ...
  const slides = [
    {
      ...
      desc: `
       UX/UI 역량을 보여주기 위해 팀장으로 진행한 NOVA 팬덤 앱 프로젝트를 선정했습니다.<br />
        ...
        <span class="indent">이를 해결하기 위해 팬 활동을 단계별(입문 – 참여 – 확장)로 구조화하고, 각 단계에서 필요한 정보와 행동을 중심으로<br />화면 흐름을 재구성했습니다. 특히 사용자의 활동 상태에 따라 노출되는 콘텐츠와 주요 CTA가 달라지도록 정책을 설계해, 자연스럽게 다음 행동으로 이어지도록 만들었습니다.</span>
